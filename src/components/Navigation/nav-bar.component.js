...
const NavBar = ({ logout }) => {
    ...
    return (
        <Fragment>
            <nav className="flex border-gray-200 border-b-1 border-yellow-100 top-0 w-full z-10 fixed py-2 px-8 flex items-center justify-between opacity-90 bg-gray-500">
                {/* Mobile Menu Icon */}
